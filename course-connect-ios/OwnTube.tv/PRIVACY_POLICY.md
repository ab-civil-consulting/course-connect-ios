...
## 1. What Information Does the Application Obtain?
...
**Important:** User account data is created and stored on the PeerTube instance server, not on our servers. The data retention and privacy practices of the PeerTube instance are governed by that instance's privacy policy.

### 1.2 Watch History

When you watch videos through the Application, your watch history is stored **locally on your device**. This data is not transmitted to our servers. Watch history is limited to a maximum of 50 items.
...
**Analytics Server Location:** PostHog analytics data is sent to EU-hosted servers (eu.i.posthog.com).
...
### 1.6 Casting Information

When you use Chromecast, AirPlay, or similar casting features, basic device discovery information is transmitted to enable casting functionality. This is controlled by your device's operating system.
...
- **Watch History:** Stored locally on your device; automatically limited to 50 most recent items
- **User Preferences:** Stored locally on your device indefinitely
- **Analytics Data:** Retained by PostHog according to their retention policies
- **User Account Data:** Retention is governed by the PeerTube instance operator

To delete your account and associated data on the PeerTube instance, contact the specific PeerTube instance administrator.
...
For data transmitted to third-party services (PeerTube, PostHog), those services implement their own security measures. Review their privacy policies for details.
...
To exercise these rights, contact us at legal@owntube.tv.

## 8. Children's Privacy

The Application is intended for users aged 13 and older. We do not knowingly collect any personal data from children under 13. If we become aware that a child under 13 has provided personal data, we will take steps to delete such information immediately and will notify parents or guardians.

If you believe a child has provided personal data, please contact us at legal@owntube.tv.
